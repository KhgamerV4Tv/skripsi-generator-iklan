...
try:
    llm_flash = ChatVertexAI(model_name="gemini-2.5-flash", temperature=0.3, max_output_tokens=8192)
except: pass

@st.cache_data(show_spinner=False)
def generate_ad_text_multimodal(kategori, user_input, gaya, platform, images_bytes_list, instruksi_revisi=""):
    """
    Kini menggunakan LangChain HumanMessage untuk mengirim piksel gambar asli (Base64) ke Gemini,
    dan mendukung instruksi revisi dari Chatbot.
    """
    content_parts = []
    
    # 1. Masukkan Instruksi Teks
    system_text = f"""ANDA ADALAH SISTEM COPYWRITER MULTIMODAL. 
TUGAS: Buat konten iklan berdasarkan teks deskripsi DAN gambar asli yang dilampirkan.
ATURAN VISUAL: 'Ide Visual' HARUS SANGAT MIRIP dengan tata letak/komposisi foto asli yang diunggah. Jangan mengarang elemen yang tidak ada di foto.
...
"""
    ...
    if "Instagram" in platform:
        system_text += "\nFORMAT WAJIB:\n## 📸 Headline: [Headline]\n**Caption:**\n[Caption]\n**Hashtags:**\n[Hashtags]\n**Ide Visual:**\n[SATU AYAT deskripsi SANGAT DETAIL DALAM BAHASA INGGRIS mereplika foto asli untuk dirender AI]\n"
    elif "WhatsApp" in platform:
        system_text += "\nFORMAT WAJIB:\n## 💬 Subject: [Subject]\n**Isi Pesan:**\n[Isi]\n**Ide Visual:**\n[SATU AYAT deskripsi SANGAT DETAIL DALAM BAHASA INGGRIS mereplika foto asli]\n"
    elif "TikTok" in platform:
        system_text += "\nFORMAT WAJIB:\n## 🎬 Judul Video: [Judul]\n**Scene 1 (0-3s):**\n- **Visual Prompt (English):** [AI Prompt]\n- **Voiceover:** [VO]\n**Scene 2 (3-10s):**\n- **Visual Prompt (English):** [AI Prompt]\n- **Voiceover:** [VO]\n**Ide Visual:**\n[SATU AYAT deskripsi SANGAT DETAIL DALAM BAHASA INGGRIS untuk cover video]\n"

    content_parts.append({"type": "text", "text": system_text})
    
    # 2. Masukkan Gambar (Encoding Base64)
    ...
    return llm_flash.invoke([message]).content
